...
image = Image.new('RGB' , room_size, (128, 128, 128))
tk_image = ImageTk.PhotoImage(image)

C.create_image(0,0, anchor="nw", image=tk_image)

diagonal_len = 20
source = C.create_rectangle(get_draw_rect_coords(s1, diagonal_len), fill='#00FF00', activeoutline='red')
receiver = C.create_rectangle(get_draw_rect_coords(r1, diagonal_len), fill='#FF0000', activeoutline='red')
